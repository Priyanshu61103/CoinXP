          ...
          <div>
            ...
            <div className="m-7 md:m-10 md:ml-15">
              <input
                ...
                className={mode==="light"?"h-10 w-84 md:w-140 rounded-sm bg-black text-white p-4 md:p-7 z-0 ...  focus:outline-0":"h-10 w-80 md:w-140 rounded-sm bg-white text-black p-4 md:p-7 z-0 ...  focus:outline-0"}
              ...
              <button
                className="h-10 w-30 rounded-sm bg-orange-600 text-white relative left-105 bottom-12 hidden md:block z-2"
              ...
              <button
                className="h-8 w-15 rounded-sm bg-orange-600 text-white relative left-63 bottom-9 block md:hidden z-2"
                onClick={searchHandler}
              >
                Search
              </button>
